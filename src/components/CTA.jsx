...
export default function CTA(){
  return (
    <section style={{background: 'var(--secondary)', padding: '2.5rem 2rem 1.25rem', textAlign: 'center', color: 'white'}}>
      ...
      <a href="mailto:elephysoftware@gmail.com" className="btn-primary" style={{background: 'white', color: 'var(--primary)', display: 'inline-block', textDecoration: 'none'}}>Hablemos Ahora</a>
    </section>
  )
}
